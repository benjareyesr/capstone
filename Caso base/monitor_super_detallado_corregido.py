...
class MonitorUltraDetallado:
    ...
    def analizar_periodo_ultra_detallado(self, periodo):
        ...
        # 8. ACTUALIZAR ESTADOS (finalizar actividades) - SOLO VIAJES
        print(f"\\n🔄 ACTUALIZANDO ESTADOS DE VIAJES...")
        for vehiculo in self.simulador.vehiculos:
            # Solo actualizar viajes, las cargas y traslados a cargar se manejan al principio
            if vehiculo.tiempo_fin_actividad == periodo:
